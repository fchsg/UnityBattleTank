...
public class UITexture : UIBasicSprite
{
	...
	public void SetItemTexture(int itemId)
	{
		Texture2D tex = (Texture2D)Resources.Load (UICommon.ITEM_PATH_PREFIX + itemId);
		mainTexture = tex;
	}

	public void SetUnitBigTexture(int unitId)
	{
		Texture2D tex = (Texture2D)Resources.Load (UICommon.UNIT_BIG_PATH_PREFIX + unitId);
		mainTexture = tex;
	}

	public void SetUnitSmallTexture(int unitId)
	{
		Texture2D tex = (Texture2D)Resources.Load (UICommon.UNIT_SMALL_PATH_PREFIX + unitId);
		mainTexture = tex;
	}
	...
	// cfj add-----------------------------------------------
	public void SetHeroSmallTexture(int heroId)
	{
		Texture2D tex = (Texture2D)Resources.Load (UICommon.HERO_SMALL_PATH_PREFIX + heroId);
		mainTexture = tex;
	}
	public void SetDropItemTexture(int itemId)
	{
		Texture2D tex = (Texture2D)Resources.Load (UICommon.DROP_ITEM_PATH_PREFIX + itemId);
		mainTexture = tex;
	}
	// cfj add-----------------------------------------------
